...
cp Montage-OOM-test.yaml.bak workflowInjector-Builder.yaml
...
#cp task-dag8.yaml.bak workflowInjector-Builder.yaml
#cp task-dag8-builder.yaml.bak workflow-builder.yaml
#cp task-dag8-injector.yaml.bak workflow-injector.yaml
#替换IP
...
#sed -i "s/0.0.0.0/$ip_master/g" workflow-builder.yaml
#sed -i "s/0.0.0.0/$ip_master/g" workflow-injector.yaml
